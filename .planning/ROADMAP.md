...
- [x] 01-05-PLAN.md — Deploy artifacts (Dockerfile, .dockerignore, nixpacks.toml, railway.toml) + Railway human-verify
...
- [x] 02-04-PLAN.md — Wave 3: 9 shadcn primitives (sonner replaces toast) + Toaster + /internal/design server component + human-verify

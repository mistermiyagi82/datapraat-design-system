...
- **Sidebar:** product-eindstaat is **popover-menu linksboven**, geen permanente sidebar. *In mockups voor pitch-decks wordt wel een permanente sidebar getoond voor leesbaarheid van navigatie-context — dit is een mock-conventie, niet de productie-UI.*
